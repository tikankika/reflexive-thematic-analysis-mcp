...
- **`phase_start` tool** — seamless phase transitions for Phase 3–6. Loads methodology, lists tool-generated files and transcripts from `rta_config.yaml`. Redirects to dedicated tools for Phase 2a/2b. Fills the gap where later phases had no start tool.

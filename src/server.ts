 ...
 * - code_read_next: Read next segment
    ...
    this.server.setRequestHandler(ListToolsRequestSchema, async () => ({
      tools: [
        ...
        },
        {
          name: 'code_start',
          description:
            'Initialize coding session. Creates STATUS frontmatter and returns first segment (raw text). Use this to start coding a new transcript.',
          inputSchema: {
            type: 'object',
            properties: {
              file_path: {
              ...
              config: {
                ...
                properties: {
                  segment_size: {
                    type: 'number',
                    description: 'Lines per segment (default: 80)',
                  },
                },
              },
            },
        ...
        },
        {
          name: 'code_read_next',
          description:
            'Read next uncoded segment. Returns raw text of next 60-100 lines based on STATUS. Use this to continue coding after accepting previous segment.',
          inputSchema: {
            type: 'object',
            properties: {
              file_path: {
        ...
        },
        {
          ...
          description:
            'Write codes for segment(s). Supports TWO MODES: (1) LEGACY (v0.1.0): single 80-line segment using STATUS boundaries - provide "codes" array. (2) NEW (v0.2.0): multiple small segments with explicit line ranges - provide "segments" array. Use NEW mode when you have identified specific meaningful units (quotes, exchanges, thematic chunks) to code precisely. Use LEGACY mode for standard sequential coding.',
          inputSchema: {
            type: 'object',
            properties: {
              file_path: {
              ...
              codes: {
                ...
                items: { type: 'string' },
                description:
                  '[LEGACY MODE - v0.1.0] Array of code strings for next 80-line segment (e.g., ["#kod_lins1", "#\\"uttryck\\"_lins1"]). Use this OR segments, not both.',
              },
              segments: {
                type: 'array',
                items: {
                  ...
                  properties: {
                    ...
                    codes: {
                      ...
                      items: { type: 'string' },
                      description:
                        'Codes for this specific segment (e.g., ["#kod1_lins1", "#kod2_lins2"]). Can be empty array.',
                    },
                  },
                  required: ['start_line', 'end_line', 'codes'],
                },
                description:
                  '[NEW MODE - v0.2.0] Array of small segments to write. Each segment has explicit line range and codes. Segments will be auto-sorted and validated for overlaps. Use this OR codes, not both.',
              },
            },
            required: ['file_path'],

...
`;
  ...
  return {
    ...
    criticalRules: [
      ...
      'Use coding manual format: #code__lens1 (underscore, double before lens)',
      'In vivo codes: #"expression"__lens1 (with quotes)',
      'Latent codes: #LATENT_interpretation__lens1 (uppercase prefix)',
